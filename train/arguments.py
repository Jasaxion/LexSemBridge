...
class RetrieverTrainingArguments(TrainingArguments):
    ...
    ignore_special_tokens: bool = field(default=False, metadata={"help": "ignore the special tokens in the loss computation"})
    computation_method: str = field(default='None', metadata={"help": "the computation method, should be original or enhanced"})
