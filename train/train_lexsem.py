...
from modeling.LexSemBridgeModeling import LexSemBridge
...
def main():
    ...
    model = LexSemBridge(model_name=model_args.model_name_or_path,
                           ...
                           ignore_special_tokens=training_args.ignore_special_tokens,
